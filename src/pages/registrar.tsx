	...
	return (
		<div className='flex flex-col justify-center items-center h-screen bg-gray-900 ' >
			<div className='flex flex-col w-screen bg-gray-900 p-2 sm:p-6 md:w-6/12 lg:w-2/6 xl:w-4/12  text-gray-300 md:bg-gray-800 rounded-2xl h-2/5 text-center mb-12 sm:mb-0 '>
				...
				<button onClick={handlerLogin} className=' bg-blue-600 mt-auto mb-8 text-white px-6 py-3 font-medium text-sm uppercase rounded shadow-md transition duration-300 hover:bg-blue-700 hover:shadow-lg inline-flex items-center justify-center'>
